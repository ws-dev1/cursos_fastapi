...
def test_delete_product_route_id_invalid():
    response = client.delete(f'/delete/1')
...
def test_list_product_route_search(db_session, products_on_db):
